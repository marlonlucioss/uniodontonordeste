        ...
        <footer class="container-fluid marketing footer">
                    ...
                    <div class="col-lg-3 footer-item">
                        ...
                        <ul class="footer-list">
                            <li class="footer-list-item">
                                <a href="http://www.ans.gov.br/">ANS - Agência Nacional de Saúde</a>
                            </li>
                            <li class="footer-list-item">
                                <a href="http://www.uniodonto.coop.br/">Uniodonto do Brasil</a>
                            </li>
                            <li class="footer-list-item">
                                <a href="http://uniodonto.coop.br/encontre-um-dentista/">Guia Odontológico Nacional</a>
                            </li>
                            <li class="footer-list-item">
                                <a href="http://www.procon.al.gov.br/">Procon</a>
                            </li>
                            <li class="footer-list-item">
                                <a href="contato.php">Sugestões/Críticas/Reclamaões</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-3 footer-item">
            ...
            <div class="row copyright">
                <h2>© Uniodonto Nordeste. Todos os direitos reservados</h2>
            </div><!-- /.row -->
